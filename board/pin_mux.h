...
#define BOARD_PTA1_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define BOARD_PTA1_GPIO_PIN_MASK (1U << 1U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_PTA1_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_PTA1_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_PTA1_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                            /* @} */
